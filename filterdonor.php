...
<div class="form-group">
    ...
    <p>
      ...
      <h3><label  for="test1">Blood</label></h3>
 ...
 if(isset($_GET['filter1']))
    {
       ...
       $search2 = $_GET["Blood"];
$query = mysqli_query($con, "SELECT * FROM bloodonor, submit_details WHERE submit_details.organ='$search2' and submit_details.dtype='Blood' AND bloodonor.id=submit_details.b_id ");
...
<div class="container-fluid">
 <form class="form-horizontal" action="" name="docview" method="GET">
<div class="form-group">
<h2> Search For Hair Donors</h2>
    <p>
<h3><label name="dtype" for="test3">Hair</label></h3>
</p>
</div>

<div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-primary" name="filter2">Submit</button>
    </div>
  </div>
