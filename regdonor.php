...
<html lang="en">
  <head>
    ...
    <title>Sign In |  LIFE SAVING RESOURE COORDINATION</title>
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="address" required>
        ...
        <p style="font-size:15px; font-family:Arial, sans-serif:"> <B>Instruction</B> : To be eligible as a donor, individuals must be at least 16 years old and weigh at least 50 kilograms.</p>
</form>
</div>
</div>
</div>
