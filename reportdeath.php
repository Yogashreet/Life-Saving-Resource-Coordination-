...
<nav class="navbar navbar-default">
  ...
  <div class="navbar-header page-scroll">
                ...
                LIFE SAVING RESOURCE COORDINATION </a>
...
$query1 = "Select * from bloodonor where  id_num = '$id_num' and uname = '$uname'";
$result1 = mysqli_query($con,$query1);
$rowz = mysqli_fetch_assoc($result1);
                            ...
                            if($rowz != null)  { 
                              ...
                              $query2 = "Select * from death where  id_num = '$id_num' and uname = '$uname'";
                              $result2 = mysqli_query($con,$query2);
                              $rowz1 = mysqli_fetch_assoc($result2);
                              
if($rowz1 == null){
                $query = "INSERT into death  (id_num,uname, email, gender, address, date, time) VALUES ('$id_num','$uname', '$email', '$gender','$address','$today','$time')" ;
                  $result = mysqli_query($con,$query);

                   if($result)
             { 
                echo "<script type='text/javascript'>alert('Death Reported!!')
              ...
              echo "<script type='text/javascript'>alert('Already Reported!')
                  document.location.href = 'reportdeath.php'</script>";
            }
                }

                else{

                  echo "<script type='text/javascript'>alert('Invalid ID/Donor!!')
                  document.location.href = 'reportdeath.php'</script>";
                }
...
<label><h6><B>User Info</B></h6></label>
<div class="container">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="address" required>
           ...
           <div align="center" style="padding: 4px; column-span: 20%;">
           <button type="submit" class="btn btn-primary" name="action">Report</button>
