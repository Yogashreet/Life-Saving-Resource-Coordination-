...
if (isset($_SESSION['reset_user']) && isset($_POST['newpwd'])) {
    ...
    $query = "UPDATE `doc_register` SET password='$newpwd' WHERE username='$username'";
    $result = mysqli_query($con, $query);

    if ($result) {
        echo "<script type='text/javascript'>alert('Password successfully reset. You can now log in with your new password.'); window.location.href = 'doclogin.php';</script>";
    } else {
...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <form action="reset_password_doc.php" method="post">
