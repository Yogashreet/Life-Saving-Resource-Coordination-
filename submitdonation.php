...
<nav class="navbar navbar-default">
  <div class="container-fluid">
         ...
         if (mysqli_num_rows($sub) > 0)
    {
     ...
     if($dtype=='Blood'){
      $organ = stripslashes($_REQUEST['Blood']);
        $organ = ($_REQUEST['Blood']);
        $organ = mysqli_real_escape_string($con,$organ);
...
<p>
    ...
    <p>
      <input name="dtype" type="radio" id="test3" value="Hair" />
      <label for="test3">Hair</label>
...
<br> <br> <br> <br> <br> 
                   &nbsp;<h3 text-color="white"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="belowbell" href="donorprofile.php">    View Your Donations</a> </h3>
  ...
  $(document).ready(function(){
    // Show organ dropdown when Organ radio button is selected
    $("#test2").on('change', function(){
      $("#organ").fadeIn();
    });

    // Show Blood dropdown when Blood radio button is selected
